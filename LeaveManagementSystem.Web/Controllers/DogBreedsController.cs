...
namespace LeaveManagementSystem.Web.Controllers
{
    public class DogBreedsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Breed,Age")] DogBreeds dogBreeds)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Breed,Age")] DogBreeds dogBreeds)
        {
            if (id != dogBreeds.Id)
            {
                return NotFound();
